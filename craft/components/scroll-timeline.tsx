...
/**
 * Progressive Blur Scroll Indicator
 * Demonstrates masking with CSS custom properties and animation-timeline
 */
		...
		<div className='w-full h-full flex items-center justify-center '>
			<div className='w-full max-w-md h-[600px] overflow-y-scroll rounded-lg   p-8 relative viewable-scroll'>
				...
				<p className='text-muted-foreground mb-6'>
					Scroll to see the blur fade in at the top and fade out at the bottom using CSS masking
				</p>
...
/**
 * SVG Stroke Drawing with Scroll
 * Shows how to animate SVG stroke-dashoffset using @property and animation-timeline
 */
		...
		<div className='w-full h-full flex items-center justify-center '>
			<div className='svg-stroke-demo-content w-full max-w-md h-[600px] overflow-y-scroll rounded-lg   relative viewable-scroll'>
				<div className='sticky top-0 w-full h-full flex items-center justify-center pointer-events-none flex-col gap-4'>
					<span className='text-xl font-light mb-4 text-muted-foreground'>Scroll to draw</span>
					<svg
