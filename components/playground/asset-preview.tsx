	...
	return (
		...
		>
			...
			<div className='flex flex-col justify-between'>
				...
				>
					<motion.button
						className='h-8 w-8 bg-background rounded-lg cursor-pointer outline-none focus:outline-none focus-visible:outline-none flex items-center justify-center group'
						onClick={onLinkClick}
					...
					>
						<HugeiconsIcon
							...
							className='h-4 w-4 stroke-2 group-hover:text-primary transition-all duration-300 transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5'
							aria-hidden='true'
						/>
					</motion.button>
