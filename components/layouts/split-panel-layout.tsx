...
} from "@/components/panels/panel-buttons";
...
export function SplitPanelLayout({
  ...
  return (
    <>
      <PreviewPanel isMaximized={isMaximized} side={previewSide}>
        {previewContent}
        <PanelButtons buttons={buttons} side={previewSide} />
      </PreviewPanel>

      <InfoPanel isMaximized={isMaximized} side={infoSide}>
        {infoContent}
      </InfoPanel>
    </>
  );
