...
export default function CodeBlock({
  ...
  return content ? (
    <div className="[&_pre]:!bg-zinc-950 dark:[&_pre]:!bg-zinc-900 custom-scrollbar [&_code]:font-mono [&_code]:text-[13px] [&_pre]:max-h-[70vh] [&_pre]:overflow-auto [&_pre]:rounded-lg [&_pre]:p-4 [&_pre]:leading-snug">
      {content}
    </div>
  ) : (
