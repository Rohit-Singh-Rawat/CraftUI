  ...
  return (
    <Drawer.Root shouldScaleBackground open={isOpen} onOpenChange={setIsOpen}>
      <Drawer.Trigger asChild>
        <button
          type="button"
          className="group mt-2 flex items-center justify-center gap-2 rounded-lg border border-[#dfeae4] px-4 py-2 text-sm transition duration-300 hover:border-[#c3c8c6] dark:border-[#1a1e1c] dark:hover:border-[#3e4742]"
        >
          ...
          <div className="flex-1 rounded-t-[10px] bg-white p-4 dark:bg-zinc-950">
            ...
            <div className="flex-1 rounded-t-[10px] bg-white p-4 dark:bg-zinc-950">
              <VisuallyHidden asChild>
                <Drawer.Title>Code Dialog</Drawer.Title>
              </VisuallyHidden>
              <button
                type="button"
                onClick={() => setIsOpen(false)}
                className="group absolute top-10 right-10 rounded-full bg-[#dfeae4] p-1 text-sm transition duration-200 ease-linear hover:bg-[#c3c8c6] dark:bg-[#1a1e1c] dark:hover:bg-[#363636]"
              >
