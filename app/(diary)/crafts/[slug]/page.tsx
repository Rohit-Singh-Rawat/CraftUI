...
export async function generateMetadata({
  ...
  const craft = await getCraftBySlug(
    resolvedParams.slug,
    craftRegistry[resolvedParams.slug],
  );
  ...
  const baseUrl =
    process.env.NEXT_PUBLIC_BASE_URL || "https://craft.rohitsinghrawat.com";
  ...
  return (
    <div className="relative flex h-full w-full flex-1 flex-col lg:flex-row lg:justify-start">
      <CraftLayoutClient
        ...
        componentFileName={
          craft.component?.path.split("/").pop() || "component.tsx"
        }
